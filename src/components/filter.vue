...
export default {
  ...
  methods: {
    searchForm: function(){
        axios
            .get(`https://cinema-api-test.herokuapp.com/movies/find?name=${this.search}&genres=${this.checkedGenre}`)
            .then(response => this.$router.push({name: 'search', params: {data: response.data }}))
    }
  },
}
</script>
